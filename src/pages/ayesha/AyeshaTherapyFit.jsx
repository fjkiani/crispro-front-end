...
const AyeshaTherapyFit = () => {
    ...
    return (
        <Container maxWidth="xl" sx={{ py: 6, bgcolor: '#f8fafc', minHeight: '100vh' }}>
            ...
            {/* 
                BEAT 0: RESISTANCE GATE (The Veto)
                Surfaces Outcome A vs B before showing therapy options.
            */}
      ...
      */}
            <Box sx={{ mb: 8, maxWidth: '1000px', mx: 'auto' }}>
                ...
                <Suspense fallback={<LoadingFallback />}>
                    <Box sx={{ mt: 4 }}>
                        <ComboRationaleCard slData={synthetic_lethality} />
                    </Box>
                </Suspense>
                ...
                <Suspense fallback={<LoadingFallback />}>
                    <Box sx={{ mt: 4 }}>
                        <DDRSubVectorCard slData={synthetic_lethality} />
                    </Box>
                </Suspense>
                ...
                <Suspense fallback={<LoadingFallback />}>
                    <Box sx={{ mt: 4 }}>
                        <HRDUnlockPanel
                            completeness={levels?.L1?.completeness}
