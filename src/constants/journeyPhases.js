...
export const UNLOCK_TESTS = [
    ...
    },
    {
        ...
        provenance: 'Directional only: GSE91061 (N=105). Permutation p=0.191 — not statistically significant. No live scoring available.',
    ...
    },
    {
        ...
        provenance: 'Validated: CN signatures (Macintyre 2018, BriTROC N=117). Display only — no live upload analysis. PMID 30017478.',
        validationStatus: 'VALIDATED',
        priority: 'MEDIUM',
        status: 'missing',
    },
