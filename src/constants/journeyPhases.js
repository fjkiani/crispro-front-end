...
export const UNLOCK_TESTS = [
    {
        ...
        provenance: 'Validated: Myriad myChoice CDx (FDA-approved). Cutoff ≥42 (PRIMA/PAOLA-1/QUADRA). PMID 31562799.',
    ...
    },
    {
        ...
        provenance: 'Validated: FoundationOne CDx (FDA-approved). Cutoff ≥10 mut/Mb (KEYNOTE-158, N=790). PMID 32534693.',
        validationStatus: 'VALIDATED',
        priority: 'HIGH',
        status: 'missing',
    },
    {
        ...
        provenance: 'Directional only: GSE91061 (N=105). Permutation p=0.191 — not statistically significant. Live axis scoring via /api/expression/ingest (IO/VEGF/Efflux/HER2 thresholds).',
    ...
    },
    {
        ...
        provenance: 'Validated: GCIG consensus criteria. KELIM score cutoff 1.0 (GOG-0218/You et al. JCO 2022). PMID 21646567.',
        validationStatus: 'VALIDATED',
        priority: 'HIGH',
        status: 'present',
    },
    {
        ...
        provenance: 'Directional: Analytically validated. Clinical utility in OC emerging. PMID 33836136.',
        validationStatus: 'DIRECTIONAL',
        priority: 'MEDIUM',
        status: 'missing',
    },
    {
        ...
        provenance: 'Validated: CN signatures (Macintyre 2018, BriTROC N=117). Live scoring via /api/ayesha/lpwgs/score (Sig7 threshold=0.25). PMID 30017478.',
        validationStatus: 'VALIDATED',
        priority: 'MEDIUM',
        status: 'missing',
    },
