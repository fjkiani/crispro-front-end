...
export const UNLOCK_TESTS = [
    ...
    },
    {
        ...
        provenance: 'Validated: FoundationOne CDx (FDA-approved). Cutoff ≥10 mut/Mb. See clinical documentation for trial references.',
        validationStatus: 'VALIDATED',
        priority: 'HIGH',
        status: 'missing',
    },
    {
        ...
        provenance: 'Directional only. No prospectively validated cutoff. No live scoring available.',
    ...
    },
    {
        ...
        provenance: 'Directional: Analytically validated. Clinical utility in OC emerging. See clinical documentation for references.',
        validationStatus: 'DIRECTIONAL',
        priority: 'MEDIUM',
        status: 'missing',
    },
    {
        ...
        provenance: 'Validated: CN signature framework. Display only — no live upload analysis. See clinical documentation for references.',
        validationStatus: 'VALIDATED',
        priority: 'MEDIUM',
        status: 'missing',
    },
